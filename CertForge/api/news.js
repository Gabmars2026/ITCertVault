...
async function enrich(n,i){let image=n.image;if(n.source!=='Google News'){try{const page=await getText(n.link,3200),og=ogImage(page.text);if(og)image=og.startsWith('//')?'https:'+og:og;if(page.url&&!page.url.includes('news.google.com'))n.link=page.url}catch{}}return{...n,image:/^https?:\/\//i.test(image||'')?image:''}}
