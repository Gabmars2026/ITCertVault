...
module.exports=async function(req,res){
  ...
  const includeCyber=['home','all-news','cybersecurity','breaking','it-news','sysadmin'].includes(category)||category.startsWith('topic-')||category==='search';
