const SOURCES={
  ...
  'techpowerup':{name:'TechPowerUp',feed:'https://www.techpowerup.com/rss/news',site:'techpowerup.com',query:'(hardware OR GPU OR CPU OR semiconductor OR gaming hardware OR technology OR cybersecurity OR vulnerability OR security update)'},
  'the-register':{name:'The Register',feed:'https://www.theregister.com/headlines.atom',site:'theregister.com',query:'(technology OR enterprise IT OR cloud OR security OR software OR hardware OR AI OR sysadmin)'}
};
